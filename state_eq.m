...
% % Input  - state vector X = (q;qdot) [6x1]
% % Output - velocity vector Xdot(t)[6x1]
% rho= 7800;
% d=0.015;
% l=0.2;
% l2=0.2; 
...
% [H,C,G] = dynamics_mat(X(1:3),X(4:6), para);
% tau = tau_plan(2,200); % planned as q2
% A = zeros(6,6);
% A(1:3,4:6) = eye(3);
% A(4:6,4:6) = -H^-1 * C;
% Xdot = [0;0;0;H^-1*(tau-G)] + A*X;
% 
% end

function [X_dot]=state_eq(t,X)
% dt=(2-0)/200;
